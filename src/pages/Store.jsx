    ...
    <>
      ...
      <section className="store" id="store">
        <div className="store-content">
            <div className="storetitle"><span className="storetitletext">Store.</span> The best way to buy the products you love.</div>
            <div className="storepara"><span className="storeparatext">The latest.</span> Take a look at what's new, right now.</div>
            <div className="store-details">
                <div className="item">
                    <div className="category">Sofa</div>
                    <div className="itemtitle">Modular Sofa</div>
                    <div className="price">Priced at Rs.<span className="price-amt">74,999.</span></div>
                    <div className="button"><button className="modularsofa addtocart">Add to Cart</button></div>
                </div>
                <div className="item">
                    <div className="category">Tables</div>
                    <div className="itemtitle">Bedside Table</div>
                    <div className="price">Priced at Rs.<span className="price-amt">15,000.</span></div>
                    <div className="button"><button className="bedsidetable addtocart">Add to Cart</button></div>
                </div>
                <div className="item">
                    <div className="category">Sofa</div>
                    <div className="itemtitle">Fabric Sofa</div>
                    <div className="price">Priced at Rs.<span className="price-amt">49,999.</span></div>
                    <div className="button"><button className="fabricsofa addtocart">Add to Cart</button></div>
                </div>
                <div className="item">
                    <div className="category">Tables</div>
                    <div className="itemtitle">Dining Table</div>
                    <div className="price">Priced at Rs.<span className="price-amt">84,999.</span></div>
                    <div className="button"><button className="diningtable addtocart">Add to Cart</button></div>
                </div>
            </div>
        </div>
    </section>
    <section className="shopcart" id="shopcart">
        <div className="cart-content">
            <div className="cart-title"><span>Shopping Cart.</span> Fill your bag with Love.</div>
            <div className="cartbox">     
             </div>
                    <div className="totalcartamt">Total Amount: Rs.<span className="total-cart-price">0</span></div>
                    <div className="orderbtn"><button className="order">Order Now</button></div>
        </div>
    </section>
    <About />
    <Footer />
